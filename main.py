...
def startWizard():
    pass  # Placeholder for the wizard logic
...
higherButton = Button(instructionsFrame, text="Higher", font=("Ubuntu", 16), fg=fgc, bg="#2C3333", command=lambda: print("Higher selected"))
higherButton.grid(pady=10, row=1, column=0, padx=10)

lowerButton = Button(instructionsFrame, text="Lower", font=("Ubuntu", 16), fg=fgc, bg="#2C3333", command=lambda: print("Lower selected"))
lowerButton.grid(pady=10, row=1, column=1, padx=10)

# Revealing the correct number
correctBtn = Button(root, text="Correct!", font=("Ubuntu", 16), fg=fgc, bg="#2C3333", command=startWizard)
correctBtn.pack(pady=10)

# Reset button to start over
resetBtn = Button(root, text="Reset", font=("Ubuntu", 16), fg=fgc, bg="#2C3333", command=lambda: print("Resetting..."))
resetBtn.place(x=700, y=20)

# Label explaining the game
instructions =  "Try to think of a whole number between 1 and 100\n" \
